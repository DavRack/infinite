...
public class admin extends user{
    ...
    public admin(String name, String nikname, String email, String birth_date, String nationality, String password, double money) {
    ...
    public static admin sign_in(String name, String nikname, String email, String birth_date, String nationality, String password, double money, boolean logged, boolean ban, int activity, boolean fake_user){
        admin administrador = new admin(name, nikname, email, birth_date, nationality, password, money);
