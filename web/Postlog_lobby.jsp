...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            Mi perfil:
            <br><br>
            <a class="btn btn-secondary" href="Servlet_Users" role="button">Ver mi perfil</a>
            ...
            <a class="btn btn-secondary" href="Servlet_Users" role="button">Cerrar Sesión</a><br><br><br>
        </div>
    </body>
</html>
